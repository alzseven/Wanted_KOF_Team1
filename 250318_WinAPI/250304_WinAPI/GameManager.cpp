...
void GameManager::Init()
{
    ...
    CharacterInfo maiInfo = CharacterInfo{
        100,
        5.f,
        "Mai",
        new StateFrameInfo[EKOF_CharacterAction::COUNT_MAX]
        {
            ...
            StateFrameInfo{
                ...
                SpriteSheetInfo{
                    ...
                    1116, 129, 9, 1, true,RGB(255, 0, 255)
                },
                RECT{0, 0, 30, 110},
            ...
            StateFrameInfo{
                ...
                SpriteSheetInfo{
                    "Mai_GuardStand",
                    TEXT("Image/Mai/Mai_GuardStand.bmp"),
                    122, 127, 1, 1, true,RGB(255, 0, 255)
                },
                RECT{0, 0, 30, 110},
                RECT{WINSIZE_X + WINSIZE_X, WINSIZE_Y + WINSIZE_Y, WINSIZE_X + WINSIZE_X, WINSIZE_Y + WINSIZE_Y},
                0,
            ...
            StateFrameInfo{
                ...
                SpriteSheetInfo{
                    "Mai_GuardSit",
                    TEXT("Image/Mai/Mai_GuardSit.bmp"),
                    122, 127, 1, 1, true,RGB(255, 0, 255)
                },
                RECT{0, 0, 30, 110},
                RECT{WINSIZE_X + WINSIZE_X, WINSIZE_Y + WINSIZE_Y, WINSIZE_X + WINSIZE_X, WINSIZE_Y + WINSIZE_Y},
    ...
    // CharacterInfo ryoInfo = CharacterInfo{
    //     100,
    //     5.f,
    //     "Ryo",
    //     new StateFrameInfo[EKOF_CharacterAction::COUNT_MAX]
    ...
    //             SpriteSheetInfo{
    //                 "Ryo_Idle",
    //                 TEXT("Image/Ryo/Ryo_Idle.bmp"),
    //                 1300, 130, 10, 1, true,RGB(255, 0, 255)
    //             },
    //             RECT{0, 0, 30, 110},
    //             RECT{0, 0, 30, 20},
    //             0,
    ...
    //             SpriteSheetInfo{
    //                 "Ryo_move_Front",
    //                 TEXT("Image/Ryo/Ryo_move_Front.bmp"),
    //                 780, 130, 6, 1, true,RGB(255, 0, 255)
    //             },
    //             RECT{0, 0, 30, 110},
    //             RECT{0, 0, 30, 20},
    //             0,
    ...
    //             SpriteSheetInfo{
    //                 "Ryo_move_Back",
    //                 TEXT("Image/Ryo/Ryo_move_Back.bmp"),
    //                 780, 130, 6, 1, true,RGB(255, 0, 255)
    //             },
    //             RECT{0, 0, 30, 110},
    //             RECT{0, 0, 30, 20},
    ...
    //             SpriteSheetInfo{
    //                 "Ryo_Wpunch",
    //                 TEXT("Image/Ryo/Ryo_Wpunch.bmp"),
    //                 390, 130, 3, 1, true,RGB(255, 0, 255)
    //             },
    //             RECT{0, 0, 30, 110},
    //             RECT{0, 0, 30, 20,},
    //             5,
    ...
    //             SpriteSheetInfo{
    //                 "Ryo_Spunch",
    //                 TEXT("Image/Ryo/Ryo_Spunch.bmp"),
    //                 650, 130, 6, 1, true,RGB(255, 0, 255)
    //             },
    //             RECT{0, 0, 30, 110},
    //             RECT{WINSIZE_X + WINSIZE_X, WINSIZE_Y + WINSIZE_Y, WINSIZE_X + WINSIZE_X, WINSIZE_Y + WINSIZE_Y},
    //             0,
    ...
    //                 "King_Guard_Stand",
    //                 TEXT("Image/King/KingGuard.bmp"),
    //                 260, 130, 2, 1, true,RGB(255, 0, 255)
    //             },
    //             RECT{0, 0, 30, 110},
    //             RECT{WINSIZE_X + WINSIZE_X, WINSIZE_Y + WINSIZE_Y, WINSIZE_X + WINSIZE_X, WINSIZE_Y + WINSIZE_Y},
    //             0,
    ...
    character2->Init(maiInfo, 2, true);
